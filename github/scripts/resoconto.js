...
async function main() {
  ...
  // Struttura: atleta → blocco → esercizio → { pianTot, esegTot, isIso }
  const struttura = {};
  sessioni.forEach(s => {
  ...
  // Raccogli tutti i blocchi e i relativi esercizi
  ...
  <div style="max-width:900px;margin:0 auto;background:#fff;border-radius:12px;overflow:hidden;border:2px solid #000">
    <div style="background:#fe6d0d;padding:24px 32px">
      ...
      <div style="color:rgba(255,255,255,0.85);font-size:13px;letter-spacing:2px;text-transform:uppercase">Resoconto Settimanale · ${settLabel}</div>
    </div>
